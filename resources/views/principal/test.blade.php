<section class="photo" id="inicio">
    ...
    <div class="photo-text">
        ...
        <p data-ix="subtitle-hero-up">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maiores, quasi
            laboriosam architecto voluptatibus et, asperiores.</p>
    </div>
    <div class="overlay"></div>
</section>
<section class="content">
    <div class="grand-title" id="servicio">
        <h4 data-ix="slowfade-scroll-bigs">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse, repellendus!
        </h4>
    </div>
    <div class="text">
        <div class="inner-text">
            ...
            <div class="text-box">
                ...
                <p data-ix="slowfade-scroll-bigs">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias, modi!
                </p>
            </div>
        </div>
        <div class="inner-text">
        ...
        <div class="portafolio-container">
            <section class="portafolio-item">
                ...
                <section class="portafolio-text">
                    <h5>genialidea</h5>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus doloremque, error nostrum
                        tempora sapiente corporis.</p>
                </section>
            </section>
            <section class="portafolio-item">
                <img src="https://unsplash.it/400/430?image=490" alt="" class="portafolio-img" />
        ...
        <form action="{{ route('send.email') }}" method="post">
            ...
            <ul class="flex-outer">
                <li>
                    ...
                    <input type="text" name="nombre" placeholder="Ingresa Nombre" class="rect" required>
                </li>
                <li>
                    <label for="correo">Correo</label>
                    <input type="email" name="correo" placeholder="Ingresa Correo" class="rect" required>
                </li>
                <li>
                    <label for="fono">Teléfono</label>
                    <input type="text" name="telefono" placeholder="Ingresa Teléfono" class="rect" required>
                </li>
                <li>
                    <label for="mensaje">Mensaje</label>
                    <textarea rows="6" name="mensaje" class="rect" required></textarea>
                </li>
                <li class="center" style="justify-content: center">
